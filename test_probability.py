...
#calculations
def test_explicit_probability(fpd, input_sets, output_sets, expected_probabilities):
...
if __name__ == "__main__":
    ...
    input_sets = [(), (1, 2, 3, 4, 5), (1, 2, 3, 4), (1, 2, 3, 4), (1, 1, 1)]
    output_sets = [(6,6,6,6,6,6), (1, 2, 3, 4, 5, 6), (1,2,3,4,5,6), (1,2,3,4,6,6), (1, 2, 3, 4, 5, 6)]
    expected_probabilities = [(1/6.0)**6, (1/6.0), 2*(1/6.0)**2, (1/6.0)**2, 0.0]
    test_explicit_probability(fpd, input_sets, output_sets, expected_probabilities)
